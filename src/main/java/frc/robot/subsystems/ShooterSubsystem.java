...
import frc.robot.generated.TunerConstants.ShooterSubsystemConstants;
  ...
  private double flywheelTargetVelocity = 0.0;
   ...
   public final Trigger isFlywheelSpinning = new Trigger(
    ...
    public final Trigger isFlywheelSpinningFar = new Trigger(
       () -> isFlywheelAt(FlywheelSetpoints.kShootRpmFar) || flywheelEncoder.getVelocity() > FlywheelSetpoints.kShootRpmFar
   );
   ...
   public Command runShooterCommandFar() {
     return this.startEnd(
       () -> this.setFlywheelVelocity(FlywheelSetpoints.kShootRpmFar),
       () -> flywheelMotor.stopMotor()
     ).until(isFlywheelSpinningFar).andThen(
       this.startEnd(
         () -> {
           this.setFlywheelVelocity(FlywheelSetpoints.kShootRpmFar);
           this.setFeederPower(FeederSetpoints.kFeed);
   ...
   public void periodic() {
    ...
    SmartDashboard.putNumber("Shooter | Feeder | Applied Output", feederMotor.getOutputCurrent());
